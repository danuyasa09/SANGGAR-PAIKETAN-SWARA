...
class ContentSeeder extends Seeder
{
    public function run(): void
    {
        $contents = [
            ...
            ['key' => 'home_about_desc1', 'value' => 'Sanggar ini hadir bukan sekadar sebagai ruang olah bakat dan pelestarian tradisi bagi anak-anak desa, melainkan sebagai wadah pembentukan karakter di era digital.', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_about_desc2', 'value' => 'Kami berkomitmen menyajikan alternatif kegiatan yang positif, mengalihkan perhatian anak-anak dari ketergantungan game online menuju keindahan gerak, nada, dan karya seni tradisi Bali. Di sini, setiap anak diajak untuk tumbuh berdaya, menjaga akar budaya, dan mengukir prestasi nyata melalui seni.', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_about_image', 'value' => '/images/pemilik_sanggar.jpg', 'type' => 'image', 'section' => 'beranda'],
            ...
            ['key' => 'home_owner_image', 'value' => '/images/pemilik_sanggar.jpg', 'type' => 'image', 'section' => 'beranda'],
            ['key' => 'home_owner_name', 'value' => 'I Ketut Suweta, S.Sn.', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_owner_role', 'value' => 'Pendiri & Pembina Sanggar Paiketan Swara', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_owner_badge', 'value' => 'SAMBUTAN PENDIRI SANGGAR', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_owner_title', 'value' => 'Dedikasi Merawat Jiwa Seni & Karakter di Tanah Leluhur', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_owner_quote', 'value' => 'Bagi kami, gamelan dan tari bukan semata pementasan keindahan, melainkan ruang pembentukan budi pekerti, gotong royong, dan kebanggaan anak-anak desa terhadap identitas budayanya.', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_owner_desc1', 'value' => 'Sejak awal berdiri di Banjar Dinas Bantas Tengah Kaja, niat kami adalah menyediakan wadah kegiatan yang sehat dan sarat nilai luhur bagi generasi muda. Kami ingin anak-anak memiliki pilihan yang lebih berharga daripada terbelenggu gawai dan game online—yaitu menyatu dalam irama gamelan dan keanggunan gerak tari Bali.', 'type' => 'text', 'section' => 'beranda'],
            ['key' => 'home_owner_desc2', 'value' => 'Kami membuka pintu seluas-luasnya bagi siapa saja—pelajar, komunitas, wisatawan nusantara maupun mancanegara—untuk datang tidak hanya sebagai penonton, tetapi sebagai sahabat yang ikut merasakan kehangatan tradisi Bali secara autentik.', 'type' => 'text', 'section' => 'beranda'],
